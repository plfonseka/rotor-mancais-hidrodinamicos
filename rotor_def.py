# -*- coding: utf-8 -*-
"""
Created on Thu Jul  2 13:45:16 2020
...
def rotor(t,h):
    ...
    g[5] = A
    g[6] = h[6]*((cyz*kzy)/(cyy*czz - cyz*czy) - (czz*(ke + 2*kyy))/(2*(cyy*czz - cyz*czy))) - h[7]*((czz*kyz)/(cyy*czz - cyz*czy) - (cyz*(ke + 2*kzz))/(2*(cyy*czz - cyz*czy))) + (ke*h[0]*czz)/(2*(cyy*czz - cyz*czy)) - (ke*h[1]*cyz)/(2*(cyy*czz - cyz*czy))/((cyy*czz)/(cyy*czz - cyz*czy))
    g[7] = -h[6]*((cyy*kzy)/(cyy*czz - cyz*czy) - (czy*(ke + 2*kyy))/(2*(cyy*czz - cyz*czy))) + h[7]*((czy*kyz)/(cyy*czz - cyz*czy) - (cyy*(ke + 2*kzz))/(2*(cyy*czz - cyz*czy))) - (ke*h[0]*czy)/(2*(cyy*czz - cyz*czy)) + (ke*h[1]*cyy)/(2*(cyy*czz - cyz*czy)) /((cyy*czz)/(cyy*czz - cyz*czy))
